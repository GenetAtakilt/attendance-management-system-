    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li><a href="studenttable1.php">Student Table</a></li>
                <li class="dropdown">
        ...
        <div id="container">
            <div class="row">
              <div class="col-md-10 col-md-offset-1 col-sm-10 col-xs-10">
                <h2 class="page-header">Department Panels</h2>
                <div class="col-md-4 col-sm-6">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <p><i class="fa fa-clock-o"></i><abbr title="Hours"> H</abbr>: Block</p>
            ...
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-xs-10">
              ...
              <div class="col-md-4 col-sm-6">
                  <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4>Chemical Engineering Department</h4>
                        <p>Mubark Kemal</p>
