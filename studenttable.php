    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="administrator.php" style="padding-left:50px; padding-top:0px;"><h3><b>ASTU</b></h3></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                <li><a href="administrator.php">Teachers Table</a></li>
                <li class="dropdown">
              ...
              <div class="col-md-10 col-md-offset-1 col-sm-10 col-xs-10">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="studentform.php"><button class="btn btn-sm btn-primary" type="button"><i class="fa fa-plus"></i> FORM</button></a>
                          ...
                          while ($row_pro=mysqli_fetch_array($run_pro)) {
                            ...
                            echo "
                                        <tr class='odd gradeX'>
                                            ...
                                            <td>$pro_stream</td>
                                            <td class='center'>
                                            <a href='studentedit.php?edit_id=$pro_id' onclick='return confirm(\"sure to edit ?\")'><button class='btn btn-sm btn-info' type='button'><i class='fa fa-edit'></i> EDIT</button></a>
