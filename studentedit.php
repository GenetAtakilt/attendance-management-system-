...
<?php 
    ...
    {
        $id = $_GET['edit_id'];
        $stmt_edit = $DB_con->prepare('SELECT fname, mname, lname, tphone, temail FROM teacher WHERE tid =:uid');
                  ...
                  <div class="x_content">
                    ...
                    <form role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tphone" value="<?php echo $phone_no; ?>" maxlength="10" required>
                        </div>
                     
                        <div class="form-group">
                            <label>Email</label>
                            <input class="form-control" type="text" name="temail" value="<?php echo $cat; ?>" required>
                       </div>
