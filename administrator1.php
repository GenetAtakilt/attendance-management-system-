                      ...
                      <tbody>
                        <?php 
                          ...
                          while ($row_pro=mysqli_fetch_array($run_pro)) {
                                  ...
                                  $pro_phone = $row_pro['tphone'];
                                  $pro_cat = $row_pro['temail'];
                            ...
                            echo "
                                        <tr class='odd gradeX'>
                                            ...
                                            <td>$pro_cat</td>
                                            <td class='center'>
                                            <a href='teacheredit1.php?edit_id=$pro_id' ><button class='btn btn-sm btn-info' type='button'><i class='fa fa-edit'></i> EDIT</button></a>
